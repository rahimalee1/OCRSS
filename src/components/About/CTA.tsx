...
const AboutCTA = ({ backgroundImage = "/images/hero/banner-bg.jpg" }: { backgroundImage?: string }) => {
  ...
  return (
    <section className="relative lg:py-28 py-16 bg-[#0D1318] dark:bg-[#0D1318] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-20" style={{ backgroundImage: `url(${backgroundImage})` }} aria-hidden />
