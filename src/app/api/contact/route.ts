...
function field(label: string, value: string, full = false) {
  return `
    <tr>
      <td style="padding:10px 16px;font-size:13px;color:#6b7280;font-weight:600;${full ? "" : "width:40%;"}border-bottom:1px solid #f3f4f6;">${label}</td>
      ${full ? "" : `<td style="padding:10px 16px;font-size:14px;color:#111827;border-bottom:1px solid #f3f4f6;">${value}</td>`}
    </tr>
    ${full ? `<tr><td colspan="2" style="padding:10px 16px 16px;font-size:14px;color:#111827;border-bottom:1px solid #f3f4f6;white-space:pre-wrap;">${value}</td></tr>` : ""}`;
}
