      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
        ...
        <tr>
          <td style="padding:20px 32px;text-align:center;border-top:1px solid #f3f4f6;">
            <p style="margin:0;font-size:12px;color:#9ca3af;">This is an automated message from your website newsletter form.</p>
...
export async function POST(request: Request) {
  try {
    ...
    const rows =
      field("Subscriber Email", email) +
      field("Source", source || "Newsletter sidebar");
    ...
    await transporter.sendMail(({
      ...
      html: emailHtml("New Newsletter Subscription", "Newsletter Signup", "#10b981", rows),
    } as any));
